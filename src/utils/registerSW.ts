...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/compare-xlsx/sw.js, scope=/compare-xlsx/）。
    // scope がツールの全 locale ページ（/compare-xlsx/, /compare-xlsx/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/compare-xlsx/sw.js', {
      scope: '/compare-xlsx/',
    });
