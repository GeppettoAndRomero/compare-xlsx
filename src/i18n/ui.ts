...
export const ui = {
  en: {
    ...
    dzDropSub: 'Drop two XLSX, XLSM, or XLS workbooks to compare',
  ...
  ja: {
    ...
    dzDropTitle: 'ドロップで変換',
    dzDropSub: '比較する XLSX・XLSM・XLS ブックを2ファイル指定できます',
  ...
  zh: {
    ...
    dzPleaseWait: '请稍候',
    dzDropTitle: '拖放即可转换',
    dzDropSub: '可拖放两个 XLSX、XLSM 或 XLS 工作簿进行比较',
  ...
  de: {
    ...
    dzDropSub: 'Zwei XLSX-, XLSM- oder XLS-Arbeitsmappen zum Vergleichen ablegen',
  ...
  es: {
    ...
    dzDropSub: 'Suelta dos libros XLSX, XLSM o XLS para compararlos',
