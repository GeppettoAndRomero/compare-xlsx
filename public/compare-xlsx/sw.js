...
const CACHE_NAME = 'compare-xlsx-v1';
const RUNTIME_CACHE = 'compare-xlsx-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/compare-xlsx/',
  '/compare-xlsx/manifest.json',
  '/compare-xlsx/icon-192.png',
  '/compare-xlsx/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/compare-xlsx/manifest.json';
}
